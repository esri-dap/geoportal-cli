...
module.exports = function (program) {
  ...
  program
    ...
    .option('--player', 'Also add a public/js folder to your new geoportal-widgets module directory with an always.js set up with an geoportal player.')
    .description('Bootstrap a subclass of geoportal-widgets with all the configuration you need to get started')
    .action(function(widgetName, options) {
      ...
      if(options.player) {
        ...
        var jsConfig = "geop.define('"+ fullWidgetName +"', {\
          \n  extend: 'geoportal-widgets',\
