...
function getCommand(command) {
  var defaultNamespace = 'geoportal:';
...
module.exports = function (program) {
  program
    .command('*')
    .usage('<commandName>')
    .description('Run an Geoportal task, possibilities listed below')
  ...
  retVal.help = function() {
    ...
    if (appPath) {
      console.log('  Geoportal Tasks:');
      exec('node ' + appPath + '/app.js geoportal:tasks');
    }
  }
